    ...
    <div class="min-h-screen flex flex-col md:flex-row">
        ...
        <div class="hidden md:flex md:w-1/2 bg-[#0f172a] relative overflow-hidden items-center justify-center p-12 text-white">
            ...
            <div class="relative z-10 text-center">
                ...
                <h1 class="text-3xl font-serif font-bold mb-2">Buat Sandi Baru</h1>
        ...
        <div class="flex-1 flex items-center justify-center p-6 md:p-12 bg-white relative">
            <div class="w-full max-w-md space-y-6">
                <div>
                    <h2 class="text-2xl font-bold text-[#0f172a]">Atur Ulang Kata Sandi</h2>
                    <p class="mt-2 text-sm text-gray-500">Silakan masukkan kata sandi baru Anda.</p>
                </div>
